...
DATA_CODE_STR = "# ORExplainer DATA CODE GOES HERE"
CONSTRAINT_CODE_STR = "# ORExplainer CONSTRAINTS CODE GOES HERE"
...
class ORExplainer(autogen.AssistantAgent):
    ...
    def _generate_reply_to_writer(self, sender):
        ...
        # with open(os.path.join(self._log_dir, "generate_code.txt"), "w") as f:
